...
#define ofxOscReceiver_settings_get(self_) self_->getSettings()
...
#define ofxOscSender_settings_get(self_) self_->getSettings()
...
static int _wrap_Receiver_setup__SWIG_1(lua_State* L) { int SWIG_arg = 0; ofxOscReceiver *arg1 = (ofxOscReceiver *) 0 ;
  ...
  return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Receiver_setup(lua_State* L) { int argc; int argv[3]={ 1,2,3} ; argc = lua_gettop(L); if (argc == 2) { int _v;
...
static int _wrap_Receiver_listening_get(lua_State* L) { int SWIG_arg = 0; ofxOscReceiver *arg1 = (ofxOscReceiver *) 0 ;
  ...
  lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Receiver_settings_get(lua_State* L) { int SWIG_arg = 0; ofxOscReceiver *arg1 = (ofxOscReceiver *) 0 ;
  ofxOscReceiverSettings *result = 0 ; SWIG_check_num_args("ofxOscReceiver::settings",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscReceiver::settings",1,"ofxOscReceiver *");
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscReceiver,0))){
    SWIG_fail_ptr("Receiver_settings_get",1,SWIGTYPE_p_ofxOscReceiver); } 
  result = (ofxOscReceiverSettings *) &ofxOscReceiver_settings_get(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ofxOscReceiverSettings,0); SWIG_arg++;  return SWIG_arg; if(0) SWIG_fail; fail:
  lua_error(L); return SWIG_arg; }
...
static swig_lua_attribute swig_Receiver_attributes[] = {
    ...
    { "settings", _wrap_Receiver_settings_get, SWIG_Lua_set_immutable },
    {0,0,0}
};
...
static int _wrap_Sender_setup__SWIG_1(lua_State* L) { int SWIG_arg = 0; ofxOscSender *arg1 = (ofxOscSender *) 0 ;
  ...
  return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Sender_setup(lua_State* L) { int argc; int argv[4]={ 1,2,3,4} ; argc = lua_gettop(L); if (argc == 2) { int _v;
    { void *ptr; if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_ofxOscSender, 0)) {
        ...
        if (lua_isuserdata(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_ofxOscSenderSettings, 0)) {
          _v = 0; }  else { _v = 1; }  }  if (_v) { return _wrap_Sender_setup__SWIG_1(L);}  }  }  if (argc == 3) { int _v; {
      void *ptr; if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_ofxOscSender, 0)) {
        _v = 0; }  else { _v = 1; }  }  if (_v) { { _v = lua_isstring(L,argv[1]); }  if (_v) { { _v = lua_isnumber(L,argv[2]); }
         if (_v) { return _wrap_Sender_setup__SWIG_0(L);}  }  }  } 
...
static int _wrap_Sender_port_get(lua_State* L) { int SWIG_arg = 0; ofxOscSender *arg1 = (ofxOscSender *) 0 ; int result;
  ...
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++; return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Sender_settings_get(lua_State* L) { int SWIG_arg = 0; ofxOscSender *arg1 = (ofxOscSender *) 0 ;
  ofxOscSenderSettings *result = 0 ; SWIG_check_num_args("ofxOscSender::settings",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscSender::settings",1,"ofxOscSender *");
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscSender,0))){
    SWIG_fail_ptr("Sender_settings_get",1,SWIGTYPE_p_ofxOscSender); } 
  result = (ofxOscSenderSettings *) &ofxOscSender_settings_get(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ofxOscSenderSettings,0); SWIG_arg++;  return SWIG_arg; if(0) SWIG_fail; fail:
  lua_error(L); return SWIG_arg; }
...
static swig_lua_attribute swig_Sender_attributes[] = {
    ...
    { "settings", _wrap_Sender_settings_get, SWIG_Lua_set_immutable },
    {0,0,0}
};
