...
static int _wrap_setCurrentDirectory(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; bool result;
    ...
    (&arg1)->assign(lua_tostring(L,1),lua_rawlen(L,1)); result = (bool)loaf::setCurrentDirectory(SWIG_STD_MOVE(arg1));
    lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_setSendHost(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; SWIG_check_num_args("loaf::setSendHost",1,1)
    if(!lua_isstring(L,1)) SWIG_fail_arg("loaf::setSendHost",1,"std::string");
    (&arg1)->assign(lua_tostring(L,1),lua_rawlen(L,1)); loaf::setSendHost(SWIG_STD_MOVE(arg1)); return SWIG_arg;
...
static int _wrap_sendBang(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; SWIG_check_num_args("loaf::sendBang",1,1)
    ...
    loaf::sendBang(SWIG_STD_MOVE(arg1)); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_sendFloat(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; float arg2 ;
    ...
    arg2 = (float)lua_tonumber(L, 2); loaf::sendFloat(SWIG_STD_MOVE(arg1),arg2); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_sendInt(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; int arg2 ;
    ...
    arg2 = (int)lua_tonumber(L, 2); loaf::sendInt(SWIG_STD_MOVE(arg1),arg2); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L);
  return 0; }
static int _wrap_sendString(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; std::string arg2 ;
    ...
    if(!lua_isstring(L,2)) SWIG_fail_arg("loaf::sendString",2,"std::string");
...
static int _wrap_setSyphonName(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ;
    ...
    (&arg1)->assign(lua_tostring(L,1),lua_rawlen(L,1)); loaf::setSyphonName(SWIG_STD_MOVE(arg1)); return SWIG_arg;
    fail: SWIGUNUSED; }  lua_error(L); return 0; }
