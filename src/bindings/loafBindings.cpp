...
static int _wrap_isVerbose(lua_State* L) { { int SWIG_arg = 0; bool result; SWIG_check_num_args("loaf::isVerbose",0,0)
    result = (bool)loaf::isVerbose(); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_setUseDefaultKeys(lua_State* L) { { int SWIG_arg = 0; bool arg1 ;
    SWIG_check_num_args("loaf::setUseDefaultKeys",1,1)
    if(!lua_isboolean(L,1)) SWIG_fail_arg("loaf::setUseDefaultKeys",1,"bool"); arg1 = (lua_toboolean(L, 1)!=0);
    loaf::setUseDefaultKeys(arg1); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_useDefaultKeys(lua_State* L) { { int SWIG_arg = 0; bool result; SWIG_check_num_args("loaf::useDefaultKeys",0,0)
    result = (bool)loaf::useDefaultKeys(); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }
   lua_error(L); return 0; }
static int _wrap_isBundled(lua_State* L) { { int SWIG_arg = 0; bool result; SWIG_check_num_args("loaf::isBundled",0,0)
    result = (bool)loaf::isBundled(); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
...
static int _wrap_setCurrentDirectory(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; bool result;
    ...
    if(!lua_isstring(L,1)) SWIG_fail_arg("loaf::setCurrentDirectory",1,"std::string"); { size_t len;
      const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); } 
    result = (bool)loaf::setCurrentDirectory(SWIG_STD_MOVE(arg1)); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++;
    return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_modKey_get(lua_State* L) { { int SWIG_arg = 0; int result; SWIG_check_num_args("loaf::modKey",0,0)
    result = (int)(int)loaf::modKey; lua_pushnumber(L, (lua_Number) result); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_reloadScript(lua_State* L) { { int SWIG_arg = 0; SWIG_check_num_args("loaf::reloadScript",0,0)
    loaf::reloadScript(); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_clearScript(lua_State* L) { { int SWIG_arg = 0; SWIG_check_num_args("loaf::clearScript",0,0)
    loaf::clearScript(); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_startListening(lua_State* L) { { int SWIG_arg = 0; SWIG_check_num_args("loaf::startListening",0,0)
    loaf::startListening(); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_stopListening(lua_State* L) { { int SWIG_arg = 0; SWIG_check_num_args("loaf::stopListening",0,0)
    loaf::stopListening(); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_isListening(lua_State* L) { { int SWIG_arg = 0; bool result; SWIG_check_num_args("loaf::isListening",0,0)
    result = (bool)loaf::isListening(); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_setListenPort(lua_State* L) { { int SWIG_arg = 0; int arg1 ; SWIG_check_num_args("loaf::setListenPort",1,1)
    ...
    loaf::setListenPort(arg1); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_getListenPort(lua_State* L) { { int SWIG_arg = 0; int result; SWIG_check_num_args("loaf::getListenPort",0,0)
    result = (int)loaf::getListenPort(); lua_pushnumber(L, (lua_Number) result); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }
   lua_error(L); return 0; }
static int _wrap_getHostname(lua_State* L) { { int SWIG_arg = 0; std::string result;
    SWIG_check_num_args("loaf::getHostname",0,0) result = loaf::getHostname();
    lua_pushlstring(L,(&result)->data(),(&result)->size()); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L);
  return 0; }
static int _wrap_setSendHost(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; SWIG_check_num_args("loaf::setSendHost",1,1)
    if(!lua_isstring(L,1)) SWIG_fail_arg("loaf::setSendHost",1,"std::string"); { size_t len;
      const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); }  loaf::setSendHost(SWIG_STD_MOVE(arg1));
    return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_getSendHost(lua_State* L) { { int SWIG_arg = 0; std::string result;
    SWIG_check_num_args("loaf::getSendHost",0,0) result = loaf::getSendHost();
    lua_pushlstring(L,(&result)->data(),(&result)->size()); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L);
  return 0; }
...
static int _wrap_getSendPort(lua_State* L) { { int SWIG_arg = 0; int result; SWIG_check_num_args("loaf::getSendPort",0,0)
    result = (int)loaf::getSendPort(); lua_pushnumber(L, (lua_Number) result); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_sendMessage(lua_State* L) { { int SWIG_arg = 0; ofxOscMessage *arg1 = 0 ;
    SWIG_check_num_args("loaf::sendMessage",1,1)
    if(!lua_isuserdata(L,1)) SWIG_fail_arg("loaf::sendMessage",1,"ofxOscMessage &");
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscMessage,0))){
      SWIG_fail_ptr("sendMessage",1,SWIGTYPE_p_ofxOscMessage); }  loaf::sendMessage(*arg1); return SWIG_arg; fail: SWIGUNUSED; }
   lua_error(L); return 0; }
static int _wrap_sendBundle(lua_State* L) { { int SWIG_arg = 0; ofxOscBundle *arg1 = 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscBundle,0))){
      SWIG_fail_ptr("sendBundle",1,SWIGTYPE_p_ofxOscBundle); }  loaf::sendBundle(*arg1); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_sendBang(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; SWIG_check_num_args("loaf::sendBang",1,1)
    if(!lua_isstring(L,1)) SWIG_fail_arg("loaf::sendBang",1,"std::string"); { size_t len;
      const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); }  loaf::sendBang(SWIG_STD_MOVE(arg1));
    return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_sendFloat(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; float arg2 ;
    ...
    if(!lua_isnumber(L,2)) SWIG_fail_arg("loaf::sendFloat",2,"float"); { size_t len;
      const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); }  arg2 = (float)lua_tonumber(L, 2);
    loaf::sendFloat(SWIG_STD_MOVE(arg1),arg2); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_sendInt(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; int arg2 ;
    ...
    if(!lua_isnumber(L,2)) SWIG_fail_arg("loaf::sendInt",2,"int"); { size_t len; const char *ptr = lua_tolstring(L, 1, &len);
      (&arg1)->assign(ptr, len); }  arg2 = (int)lua_tonumber(L, 2); loaf::sendInt(SWIG_STD_MOVE(arg1),arg2); return SWIG_arg;
...
static int _wrap_sendString(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ; std::string arg2 ;
    ...
    if(!lua_isstring(L,2)) SWIG_fail_arg("loaf::sendString",2,"std::string"); { size_t len;
      const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); }  { size_t len;
      const char *ptr = lua_tolstring(L, 2, &len); (&arg2)->assign(ptr, len); } 
    loaf::sendString(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2)); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_startSyphon(lua_State* L) { { int SWIG_arg = 0; SWIG_check_num_args("loaf::startSyphon",0,0)
    loaf::startSyphon(); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_setSyphonName(lua_State* L) { { int SWIG_arg = 0; std::string arg1 ;
    ...
    { size_t len; const char *ptr = lua_tolstring(L, 1, &len); (&arg1)->assign(ptr, len); } 
    loaf::setSyphonName(SWIG_STD_MOVE(arg1)); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_getSyphonServer(lua_State* L) { { int SWIG_arg = 0; ofxSyphonServer *result = 0 ;
    ...
    SWIG_NewPointerObj(L,result,SWIGTYPE_p_ofxSyphonServer,0); SWIG_arg++;  return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L);
  return 0; }
